...
const ApiTester = () => {
    ...
    const handleTestApi = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`/api/ckan/${endpoint.replace(/^\/+/, '')}`, options);
                ...
                <div className="card">
                    ...
                    <div className="space-y-4 mb-8">
                        <p className="text-gray-600 mb-4">
                            Test the CKAN REST API securely through the Next.js rewrite proxy.
                        </p>
                        ...
                        <form onSubmit={handleTestApi} className="space-y-4">
                            ...
                            <button type="submit" className="bg-blue-600 hover:bg-blue-700 transition text-white px-6 py-2 rounded font-medium" disabled={loading}>
