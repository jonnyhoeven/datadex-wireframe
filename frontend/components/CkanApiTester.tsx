                ...
                <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
                    <div className="flex flex-col md:flex-row gap-8 items-center text-left">
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#f6a732]/10 text-[#f6a732] font-semibold text-sm mb-4">
                                <Database size={16} />
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                                Ontsluit de kracht van open data voor Openbare Orde en Veiligheid. Onze robuuste CKAN API stelt ontwikkelaars in staat om naadloos metadata te doorzoeken, filteren en integreren in externe applicaties.
                            </p>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <aside className="lg:col-span-1 space-y-8 order-2 lg:order-1">
                        <section>
                            ...
                            <ul className="space-y-3 text-left">
                                {[
                                    ...
                                    <li key={idx} className="flex items-center gap-3 p-3 rounded-lg bg-white border border-gray-100 shadow-sm hover:border-[#f6a732] transition-colors cursor-pointer group">
                        ...
                        <section className="bg-blue-50 border border-blue-100 p-6 rounded-xl text-left">
                            ...
                            <p className="text-sm text-blue-700 leading-relaxed">
                                Voor publieke data is geen API-key vereist. Wil je data uploaden of private datasets inzien? Neem dan contact op met het Data4OOV beheerteam voor een persoonlijke sleutel.
                            </p>
                        </section>
                    </aside>
                    ...
                    <div className="lg:col-span-2 space-y-12 order-1 lg:order-2 text-left">
                            ...
                            <form onSubmit={handleTestApi} className="space-y-6">
                                ...
                                {(method === 'POST' || method === 'PUT') && (
                                    <div className="flex flex-col w-full">
                                        <label className="font-semibold text-sm mb-2 text-gray-700">Request Body (JSON)</label>
                                        <textarea
                            ...
                            {response && (
                                <div className="mt-8 pt-8 border-t border-gray-100">
                                    <h3 className="text-xl font-bold mb-4 flex items-center justify-between">
                                        ...
                                        {response.status && (
                                            <span className={`text-xs px-3 py-1 rounded-full text-white font-mono ${response.ok ? 'bg-green-500' : 'bg-red-500'}`}>
                                                HTTP {response.status}
                                            </span>
                                        )}
                                    </h3>
                                    <div className="relative group">
                                        <pre className="bg-gray-900 text-green-400 p-6 rounded-xl overflow-x-auto text-sm font-mono leading-relaxed shadow-inner max-h-[500px]">
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-mono font-bold">
                                            {endpoint.method}
                                        </span>
                                        <div className="flex-1">
                                        ...
                                        <ChevronRight size={16} className="text-gray-300 group-hover:text-[#f6a732] transition-colors" />
                                    </div>
                                ))}
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="relative group">
                                <pre className="bg-gray-900 text-gray-100 p-6 rounded-xl overflow-x-auto font-mono text-sm leading-relaxed shadow-lg border border-gray-800">
                        ...
                        {/* Call to Action */}
                        <section className="bg-white border-2 border-dashed border-gray-200 p-8 rounded-2xl text-center">
                            <h3 className="text-xl font-bold mb-3">Klaar om te bouwen?</h3>
                            <p className="text-gray-600 mb-6">
                                Bekijk de volledige officiële CKAN API documentatie voor geavanceerde opties zoals filtering en data-pushes.
                            </p>
                            <Link 
                                href="https://docs.ckan.org/en/latest/api/index.html" 
                                target="_blank" 
