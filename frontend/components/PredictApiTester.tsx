                ...
                <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
                    <div className="flex flex-col md:flex-row gap-8 items-center text-left">
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#75b9d8]/10 text-[#75b9d8] font-semibold text-sm mb-4">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                                Ontdek hoe AI helpt bij het ontsluiten van de juiste data. Onze Activity Predictor suggereert automatisch de meest relevante kaartlagen op basis van incidenttitels en betrokken domeinen.
                            </p>
                        </div>
            ...
            <main className="max-w-6xl mx-auto px-4 py-12">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <aside className="lg:col-span-1 space-y-8 order-2 lg:order-1">
                        <section>
                            ...
                            <ul className="space-y-3 text-left">
                                {[
                                    ...
                                    <li key={idx} className="flex items-center gap-3 p-3 rounded-lg bg-white border border-gray-100 shadow-sm hover:border-[#75b9d8] transition-colors cursor-pointer group">
                        ...
                        <section className="bg-blue-50 border border-blue-100 p-6 rounded-xl text-left">
                            ...
                            <p className="text-sm text-blue-700 leading-relaxed mb-4">
                                We maken gebruik van <strong>RobBERT</strong> voor taalbegrip en <strong>TensorFlow</strong> voor de voorspellingen.
                            </p>
                            <Link href="https://pieter.ai/robbert/" target="_blank" className="text-xs font-bold text-blue-600 hover:underline flex items-center gap-1">
                    ...
                    <div className="lg:col-span-2 space-y-12 order-1 lg:order-2 text-left">
                        ...
                        {/* Predictor Console */}
                        <section id="predictor-console" className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        link: 'https://github.com/jonnyhoeven/datadex-wireframe'
                                    }
                                ].map((step, idx) => (
                                    <div key={idx} className="space-y-3">
                                        ...
                                        <Link href={step.link} target="_blank" className="text-xs font-semibold text-[#75b9d8] hover:underline flex items-center gap-1">
                        ...
                        {response && (
                            <section>
                                ...
                                <div className="relative group">
                                    <pre className="bg-gray-900 text-green-400 p-6 rounded-xl overflow-x-auto text-sm font-mono leading-relaxed shadow-inner max-h-[400px]">
