            ...
            <div className="mb-12">
                ...
                <div className="prose prose-blue max-w-none text-gray-600 space-y-4">
                    <p className="text-lg leading-relaxed">
                        Je kijkt nu naar de interactieve testomgeving voor ons slimme voorspellingsmodel. Maar wat gebeurt er nu eigenlijk op de achtergrond wanneer je hier een incident of activiteit invoert?
                    </p>
                    
                    <p className="text-lg leading-relaxed">
                        Stel je voor dat er een melding binnenkomt van een <span className="italic">"brand in een schouwburg"</span>. Om effectief te kunnen handelen, hebben hulpdiensten direct de juiste kaartlagen nodig op hun scherm—denk aan gebouwindelingen, brandkranen in de buurt of aanrijroutes. Deze tool is ontworpen om <strong className="text-gray-900">automatisch de meest relevante kaartlagen te suggereren</strong>, puur op basis van de titel van het incident en de betrokken hulpdiensten (zoals Brandweer of Politie).
                    </p>
                    ...
                    <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100 my-8">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <p className="text-sm">
                                    We gebruiken een krachtig AI-taalmodel (<strong className="text-blue-800">RobBERT</strong>) dat de dieperliggende betekenis en context van jouw tekst begrijpt en vertaalt naar wiskundige vectoren.
                                </p>
                            </div>
                            <div>
                                <h4 className="font-bold text-gray-900 text-sm mb-2">2. De Voorspelling</h4>
                                <p className="text-sm">
                                    Ons <strong className="text-blue-800">Neurale Netwerk</strong> (het 'brein') combineert de tekst met de gekozen domeinen om te bepalen welke kaartlagen cruciaal zijn voor dit scenario.
                                </p>
                            </div>
                            <div>
                                <h4 className="font-bold text-gray-900 text-sm mb-2">3. De Orkestrator</h4>
                                <p className="text-sm">
                                    Deze applicatie fungeert als dirigent: het koppelt het taalmodel aan het brein en vertaalt de resultaten direct naar bruikbare kaartlagen op jouw scherm.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <p>
                        Vul een incident in en selecteer de betrokken domeinen. Je maakt op dit moment live gebruik van een gedistribueerde <span className="italic">machine learning pipeline</span> die natuurlijke taal direct omzet in operationele inzichten.
                    </p>
                </div>
            </div>
